...
export default function DashboardPage() {
   ...
   * Temporary data.
   *
   * بعد ما تربط الـ API/database استبدل القيم دي
   * بالبيانات الحقيقية للمستخدم.
   */
  const cvData = {
    personalInfo: {
      firstName: "Sarah",
  ...
  const completionSections = [
    {
      label: "Personal Info",
      done: Boolean(cvData.personalInfo.firstName && cvData.personalInfo.email),
    },
    {
      label: "Experience",
    ...
    {
      label: "Education",
      done: cvData.education.length > 0,
    },
    {
      label: "Skills",
    ...
    {
      label: "Projects",
      done: cvData.projects.length > 0,
    },
    {
      label: "Certificates",
      done: cvData.certificates.length > 0,
    },
  ];
  ...
  const handleGenerate = () => {
    ...
    // هنا بعدين تحط API request بتاع AI.
    setTimeout(() => {
      setGenerating(false);
  ...
  const handleManualStart = () => {
    ...
    const firstSection = ALL_SECTIONS.find(
      (section) => section.id === manualSections[0],
    );

    if (firstSection) {
      router.push(firstSection.href);
    }
  };
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Your CV is {pct}% complete. Keep going!
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {completed} of {completionSections.length} sections filled
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-6">
          ...
          >
            ...
            <p className="text-violet-200 text-sm leading-relaxed mb-4">
              Paste a job description, select your target role, and let our AI
              generate and optimize your CV automatically.
            </p>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">
              Build My CV Manually
            </h3>

            <p className="text-gray-500 text-sm leading-relaxed mb-4">
              Choose exactly which sections to include and fill in your details
              at your own pace with full control.
            </p>
        ...
        <Card className="p-6 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Let AI create a tailored CV for your target role
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Field
              ...
              required
              hint="Paste the full job description for the best results"
            >
              <Textarea
                value={aiJobDesc}
                onChange={setAiJobDesc}
            ...
            <Btn
              ...
              disabled={generating || !aiRole.trim() || !aiJobDesc.trim()}
            >
              {generating ? (
                <>
        ...
        <Card className="p-6 mb-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Select which sections to include in your CV
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
            {ALL_SECTIONS.map((section) => {
              const active = manualSections.includes(section.id);
          ...
          <div className="flex gap-3">
            <Btn onClick={handleManualStart} disabled={!manualSections.length}>
              Start with {manualSections.length} section
              {manualSections.length !== 1 ? "s" : ""}
              <ArrowRight size={15} />
            </Btn>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          {
            label: "Experience",
            count: `${cvData.experiences.length} entries`,
          ...
          {
            label: "Education",
            count: `${cvData.education.length} entries`,
          ...
          {
            label: "Skills",
            count: `${cvData.skills.length} skills`,
            icon: <Zap size={18} />,
            href: "/profile/skill",
          ...
          {
            label: "Certificates",
            count: `${cvData.certificates.length} certs`,
            icon: <Award size={18} />,
            href: "/profile/certificates",
