        ...
        <div className="lg:col-span-3 flex flex-col gap-5">
            ...
            {experiences.length === 0 ? (
              ...
              <div className="flex flex-col gap-3">
                {experiences.map((exp) => (
                  <div
                    key={exp.id}
                    className="flex gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50 hover:border-gray-200 transition-colors"
                  >
          ...
          <Card className="p-6">
            ...
            <p className="text-xs text-gray-400 mb-4">
              This is how your experience section will appear in your CV
            </p>
            ...
            <div className="border-t-2 border-violet-600 pt-4">
              ...
              {experiences.length === 0 ? (
                <p className="text-xs text-gray-400 italic">
                  Add experience to see the preview
                </p>
              ) : (
